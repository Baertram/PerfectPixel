--English (base) translations for the addon PerfectPixel
-->This file will always be loaded. Other language files will be loaded afterwards (like de.lua if you are using the German game client)
local stringsEn = {
    --[LAM settings]
